...
MENU_PIT = Pixel(MENU_OFFSET_X, 77)
MENU_ADVENTURE = Pixel(MENU_OFFSET_X, 104)
MENU_INVENTORY = Pixel(MENU_OFFSET_X, 131)
MENU_AUGMENTATIONS = Pixel(MENU_OFFSET_X, 158)
MENU_ADV_TRAINING = Pixel(MENU_OFFSET_X, 186)
MENU_TIME_MACHINE = Pixel(MENU_OFFSET_X, 213)
MENU_BLOOD_MAGIC = Pixel(MENU_OFFSET_X, 240)
MENU_WANDOOS = Pixel(MENU_OFFSET_X, 267)
MENU_NGU = Pixel(MENU_OFFSET_X, 294)
MENU_YGGDRASIL = Pixel(MENU_OFFSET_X, 321)
MENU_DIGGERS = Pixel(MENU_OFFSET_X, 348)
MENU_BEARD = Pixel(MENU_OFFSET_X, 375)
MENU_QUESTING = Pixel(MENU_OFFSET_X, 402)
MENU_HACKS = Pixel(MENU_OFFSET_X, 429)
MENU_WISHES = Pixel(MENU_OFFSET_X, 456)
MENU_ITEMS = {
...
DIG_DEACTIVATE_ALL = Pixel(906, 110)
...
# STATS OCR
OCR_ENERGY = OCRBox(13, 31, 160, 50)
OCR_MAGIC = OCRBox(13, 71, 160, 90)
OCR_R3 = OCRBox(13, 111, 160, 133)
...
FCCY_ZERO = 22 # FEATURE_COLOR_CHECK_Y_ZERO, Basic training
...
COLOR_SPELL_READY = ColorPixel(FCCX, FCCY_ZERO+FCCY_OFFSET*8, 'BA13A7')
